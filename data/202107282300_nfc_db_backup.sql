CREATE DATABASE  IF NOT EXISTS `nofluffcars` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `nofluffcars`;
...
INSERT INTO `country` VALUES (1,'USA'),(2,'Great Britain'),(3,'Spain'),(4,'France'),(5,'Germany'),(6,'Italy'),(7,'Norway'),(8,'Sweden'),(9,'Czech Republic'),(10,'Japan'),(999,'unknown');
...
CREATE TABLE `generation` (
  ...
  CONSTRAINT `model_fk` FOREIGN KEY (`IDmodel`) REFERENCES `model` (`ID`)
...
CREATE TABLE `manufacturer` (
  ...
  CONSTRAINT `manufacturer_country_ID_fk` FOREIGN KEY (`IDcountry`) REFERENCES `country` (`ID`)
...
CREATE TABLE `model` (
  ...
  CONSTRAINT `manufacturer_fk` FOREIGN KEY (`IDmanufacturer`) REFERENCES `manufacturer` (`ID`)
...
INSERT INTO `model` VALUES (1,13,'3 series'),(2,13,'5 series'),(3,13,'7 series'),(4,11,'A4'),(5,11,'A6'),(6,11,'A8'),(7,49,'C class'),(8,49,'E class'),(9,49,'S class');
...
-- Dump completed on 2021-07-28 23:29:32
