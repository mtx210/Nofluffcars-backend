...
CREATE TABLE `manufacturer` (
  ...
  `name` varchar(20) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `manufacturer_country_ID_fk` (`ID_country`),
  CONSTRAINT `manufacturer_country_ID_fk` FOREIGN KEY (`ID_country`) REFERENCES `country` (`ID`)
...
-- Dump completed on 2021-07-28 21:34:21
